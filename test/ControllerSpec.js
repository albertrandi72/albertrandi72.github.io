...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
			...
			var completedTodo = { title: 'my active todo', completed: true }
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var activeTodo = { id: 1, title: 'my active todo', completed: false }
			var activeTodo2 = { id: 2, title: 'my active todo 2', completed: false }
			setUpModel([activeTodo, activeTodo2]);
			subject.setView('');
